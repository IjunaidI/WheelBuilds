...
export const VENDOR_TERAFLEX_WHEELS_ENABLED = process.env.VENDOR_TERAFLEX_WHEELS_ENABLED
export const VENDOR_TERAFLEX_WHEEL_FEED_PATH = process.env.VENDOR_TERAFLEX_WHEEL_FEED_PATH
export const VENDOR_TERAFLEX_TIRES_ENABLED = process.env.VENDOR_TERAFLEX_TIRES_ENABLED
export const VENDOR_TERAFLEX_TIRE_FEED_PATH = process.env.VENDOR_TERAFLEX_TIRE_FEED_PATH
