...
| `VENDOR_SYNC_FEED_ARCHIVE_BUCKET` | `vendor-feeds` | Dedicated PRIVATE MinIO bucket for durable feed archives (WB-017); created with no bucket policy, separate from the public `medusa-media` bucket |
