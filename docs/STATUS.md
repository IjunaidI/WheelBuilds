...
| PDP | working-with-gaps | Live price/stock, variant grid, vehicle band. Add-to-cart + Buy Now wired (WB-001 done); grid collapses bolt patterns; fitment=[]. | [done/plans/2026-05-23-storefront-phase2.md](done/plans/2026-05-23-storefront-phase2.md) | WB-003, WB-009, WB-029, WB-030 |
...
## Active work
- None in progress. **WB-002** (authed garage mutations) shipped to `main`. Next up: **WB-003** (PDP variant grid collapses bolt patterns) or **WB-009** (PDP fitment).
