...
| Fitment (wheel-size) | working-with-gaps | Live by_model lookups durably DB-cached + quota guard; reverse-fitment "N confirmed models" live (WB-009 done); no TTL/expiry, no warm cron. | [done/plans/2026-05-30-wheel-size-fitment-garage.md](done/plans/2026-05-30-wheel-size-fitment-garage.md) | WB-007, WB-008, WB-019, WB-020 |
...
| PDP | working-with-gaps | Live price/stock, variant grid, vehicle band. Add-to-cart + Buy Now wired (WB-001 done); bolt-pattern row gates the grid (WB-003 done); reverse-fitment "N confirmed models" live (WB-009 done). | [done/plans/2026-05-23-storefront-phase2.md](done/plans/2026-05-23-storefront-phase2.md) | WB-029, WB-030 |
