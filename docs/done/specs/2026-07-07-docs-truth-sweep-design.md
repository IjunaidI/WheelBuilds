...
| Fact | Evidence |
|---|---|
| `resolveSelectedVariant` referenced ONLY by itself + its test (5 self-hits); hero uses `resolveLeafVariant`. Its test has 2 `tsc` errors (missing `centerBoreMm`/`loadRatingLb` on the fixture) baked into the 14-baseline. | `resolve-variant.ts:9` *(deleted by this spec's own DOC1)*, [group-sizes.ts:158](../../../storefront/src/modules/product-detail/data/group-sizes.ts#L158) |
