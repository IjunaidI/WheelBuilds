...
- done (code): 2026-07-20 — SDD on `feat/wb-115-dead-image-exclusion` (3 impl tasks, per-task reviews [2× opus], opus whole-branch review, 2 fix waves). Tips: 1=`965978e`, 2=`12a4f0a`+`aaad70b`, 3=`8ae62fd`+`6923368`, final fixes `cab14a9`+`fb825b0`. Gate: backend jest **450** + medusa build 0; storefront vitest **868** + tsc 2-baseline + next build 0.
