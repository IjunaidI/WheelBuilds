// storefront/src/modules/tire-discovery/components/filter-rail/mobile-trigger-copy.ts
//
// Pure label builders for TireMobileFilterTrigger (WB-088 D7 — parity port
// of the wheel discovery/components/filter-rail/mobile-trigger-copy.ts).
// Split out from the component so the honest-cap branch is unit-testable
// without a React render harness (this repo has no RTL/jsdom component-test
// infra — see get-tire-products.cap.test.ts for the same pure-function
// pattern).
//
