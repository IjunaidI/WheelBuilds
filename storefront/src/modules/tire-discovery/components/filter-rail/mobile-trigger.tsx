 ...
 * aside uses. Mirrors modules/discovery/components/filter-rail/mobile-trigger.tsx
 * with the tire facet vocabulary (no fitment).
 */
      ...
      >
        ...
        >
          ...
          <DrawerDescription className="sr-only">
            Narrow the catalog by brand, size, type, speed rating, load rating, and price.
          </DrawerDescription>
...
export default TireMobileFilterTrigger
