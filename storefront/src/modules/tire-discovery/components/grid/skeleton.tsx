...
/**
 * Product grid skeleton — matches the shape of `<TireGrid>` so the layout
 * doesn't shift when real cards swap in. Used by the tire store's
 * `loading.tsx` and by any future Suspense boundary that wraps a server-side
 * product fetch. Field-agnostic placeholder cards — mirrors
 * modules/discovery/components/grid/skeleton.tsx verbatim.
 */
const TireGridSkeleton = ({
...
export default TireGridSkeleton
